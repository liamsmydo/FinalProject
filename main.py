...
def main():
    ...
    parser.add_argument('-t', type=ip_input, help="Target IPs or ranges (ex. '192.168.1.1,192.168.1.2' or '192.168.1.1-192.168.1.10')", required=True)
    parser.add_argument('-s', help='Scan Type q = quick (Common Ports), t = thorough (All ports) c = custom)')
